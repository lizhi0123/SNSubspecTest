# "pod spec create QKChineseVerifyCode" 创建 QKChineseVerifyCode.podspec 的命令
#  Be sure to run `pod spec lint QKChineseVerifyCode.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  青客用的中文验证码，点击 红色 中文文字 才能通过验证。
                   DESC

  s.homepage     = "http://www.qk365.com/"
  ...
  s.source_files  = "QKChineseVerifyCode/**/*.{h,m}"
  s.exclude_files = "QKChineseVerifyCode/Exclude"
   s.resource_bundles = {
...
#   s.subspec 'SNSubspec1' do |ss|
#       ss.ios.deployment_target = '7.0'
# #      ss.osx.deployment_target = '10.9'
# #      ss.tvos.deployment_target = '9.0'

#       ss.source_files = 'QKChineseVerifyCode/SNSubspec1.{h,m}'
